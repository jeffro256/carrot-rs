...
pub fn make_carrot_enote_ephemeral_privkey(anchor_norm: &JanusAnchor,
    ...
    payment_id: &PaymentId) -> EnoteEphemeralKey
{
...
pub fn make_carrot_enote_ephemeral_pubkey_cryptonote(enote_ephemeral_privkey: &EnoteEphemeralKey)
...
pub fn make_carrot_enote_ephemeral_pubkey_subaddress(enote_ephemeral_privkey: &EnoteEphemeralKey,
    address_spend_pubkey: &AddressSpendPubkey) -> Option<EnoteEphemeralPubkey>
{
...
pub fn make_carrot_enote_ephemeral_pubkey(enote_ephemeral_privkey: &EnoteEphemeralKey,
    address_spend_pubkey: &AddressSpendPubkey,
    is_subaddress: bool) -> Option<EnoteEphemeralPubkey>
{
    if is_subaddress
    {
    ...
    {
        // D_e = d_e B
        Some(make_carrot_enote_ephemeral_pubkey_cryptonote(enote_ephemeral_privkey))
    }
}
...
pub fn make_carrot_uncontextualized_shared_key_sender(enote_ephemeral_privkey: &EnoteEphemeralKey,
    address_view_pubkey: &AddressViewPubkey) -> Option<MontgomeryECDH>
{
    ...
    Some(MontgomeryECDH(&enote_ephemeral_privkey.0.0 * convert_to_montgomery_vartime(&address_view_pubkey.0)?))
}

pub fn make_carrot_view_tag(s_sender_receiver_unctx: &[u8; 32],
    input_context: &InputContext,
...
pub fn make_carrot_sender_receiver_secret(s_sender_receiver_unctx: &[u8; 32],
    enote_ephemeral_pubkey: &EnoteEphemeralPubkey,
    input_context: &InputContext) -> SenderReceiverSecret
{
...
pub fn make_carrot_onetime_address_extension_g(s_sender_receiver: &SenderReceiverSecret,
...
pub fn make_carrot_onetime_address_extension_t(s_sender_receiver: &SenderReceiverSecret,
...
pub fn make_carrot_onetime_address_extension_pubkey(s_sender_receiver: &SenderReceiverSecret,
    amount_commitment: &AmountCommitment) -> OnetimeExtension
{
    // k^o_g = H_n("..g..", s^ctx_sr, C_a)
    let onetime_ext_g = make_carrot_onetime_address_extension_g(s_sender_receiver, 
        amount_commitment);

    // k^o_t = H_n("..t..", s^ctx_sr, C_a)
    let onetime_ext_t = make_carrot_onetime_address_extension_t(s_sender_receiver,
        amount_commitment);
...
pub fn make_carrot_onetime_address(address_spend_pubkey: &AddressSpendPubkey,
...
pub fn make_carrot_amount_blinding_factor(s_sender_receiver: &SenderReceiverSecret,
    amount: Amount,
    address_spend_pubkey: &AddressSpendPubkey,
    enote_type: CarrotEnoteType) -> AmountBlindingKey
{
...
pub fn encrypt_carrot_anchor(anchor: &JanusAnchor,
    s_sender_receiver: &SenderReceiverSecret,
    onetime_address: &OutputPubkey) -> EncryptedJanusAnchor
{
    // m_anchor = H_16(s^ctx_sr, Ko)
...
pub fn decrypt_carrot_anchor(encrypted_anchor: &EncryptedJanusAnchor,
    s_sender_receiver: &SenderReceiverSecret,
    onetime_address: &OutputPubkey) -> JanusAnchor
{
    // m_anchor = H_16(s^ctx_sr, Ko)
    let mask = make_carrot_anchor_encryption_mask(s_sender_receiver, onetime_address);
...
pub fn make_carrot_amount_encryption_mask(s_sender_receiver: &SenderReceiverSecret,
...
pub fn encrypt_carrot_amount(amount: Amount,
    s_sender_receiver: &SenderReceiverSecret,
    onetime_address: &OutputPubkey) -> EncryptedAmount
{
    // m_a = H_8(s^ctx_sr, Ko)
...
pub fn decrypt_carrot_amount(encrypted_amount: &EncryptedAmount,
    s_sender_receiver: &SenderReceiverSecret,
    onetime_address: &OutputPubkey) -> Amount
{
    // m_a = H_8(s^ctx_sr, Ko)
    let mask = make_carrot_amount_encryption_mask(s_sender_receiver, onetime_address);
...
pub fn make_carrot_payment_id_encryption_mask(s_sender_receiver: &SenderReceiverSecret,
...
pub fn encrypt_legacy_payment_id(payment_id: &PaymentId,
    s_sender_receiver: &SenderReceiverSecret,
    onetime_address: &OutputPubkey) -> EncryptedPaymentId
{
    // m_pid = H_8(s^ctx_sr, Ko)
...
pub fn decrypt_legacy_payment_id(encrypted_payment_id: &EncryptedPaymentId,
    s_sender_receiver: &SenderReceiverSecret,
    onetime_address: &OutputPubkey) -> PaymentId
{
    // m_pid = H_8(s^ctx_sr, Ko)
    let mask = make_carrot_payment_id_encryption_mask(s_sender_receiver, onetime_address);
...
pub fn make_carrot_janus_anchor_special(enote_ephemeral_pubkey: &EnoteEphemeralPubkey,
    input_context: &InputContext,
    onetime_address: &OutputPubkey,
    k_view: &ViewIncomingKey) -> JanusAnchor
{
...
pub fn recover_address_spend_pubkey(onetime_address: &OutputPubkey,
    s_sender_receiver: &SenderReceiverSecret,
    amount_commitment: &AmountCommitment) -> Option<AddressSpendPubkey>
{
    // K^o_ext = k^o_g G + k^o_t T
    let sender_extension_pubkey = make_carrot_onetime_address_extension_pubkey(s_sender_receiver,
        amount_commitment);
...
pub fn test_carrot_view_tag(s_sender_receiver_unctx: &[u8; 32],
    input_context: &InputContext,
    onetime_address: &OutputPubkey,
    view_tag: &ViewTag) -> bool
{
    // vt' = H_3(s_sr || input_context || Ko)
    let nominal_view_tag = make_carrot_view_tag(s_sender_receiver_unctx, input_context, onetime_address);

    // vt' ?= vt
    nominal_view_tag == *view_tag
}

pub fn try_recompute_carrot_amount_commitment(s_sender_receiver: &SenderReceiverSecret,
...
{
    // k_a' = H_n(s^ctx_sr, a', K^j_s', enote_type')
    let amount_blinding_factor = make_carrot_amount_blinding_factor(s_sender_receiver,
        nominal_amount,
...
pub fn try_get_carrot_amount(s_sender_receiver: &SenderReceiverSecret,
...
pub fn verify_carrot_normal_janus_protection(nominal_anchor: &JanusAnchor,
    input_context: &InputContext,
    nominal_address_spend_pubkey: &AddressSpendPubkey,
    is_subaddress: bool,
    nominal_payment_id: &PaymentId,
    enote_ephemeral_pubkey: &EnoteEphemeralPubkey) -> bool
{
